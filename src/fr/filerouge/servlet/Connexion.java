...
public class Connexion extends HttpServlet {
	private static final String URL = "/Connexion.jsp";
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Client utilisateur = form.getUtilisateur(req);
		...
		//this.getServletContext().getRequestDispatcher("/restreint/accesRestreint.jsp").forward(req, resp);
		 resp.sendRedirect("./restreint/accesRestreint.jsp");
	}
